...
if("TRUE" STREQUAL "TRUE")
  set(canopen_master_SOURCE_PREFIX /home/spb/catkin_move_it/src/canopen_master)
  set(canopen_master_DEVEL_PREFIX /home/spb/catkin_move_it/devel)
  ...
  set(canopen_master_INSTALL_PREFIX /home/spb/catkin_move_it/install)
...
if(NOT "/home/spb/catkin_move_it/src/canopen_master/include;/usr/include " STREQUAL " ")
  set(canopen_master_INCLUDE_DIRS "")
  set(_include_dirs "/home/spb/catkin_move_it/src/canopen_master/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'canopen_master' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mathias Lüdtke <mathias.luedtke@ipa.fraunhofer.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'canopen_master' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spb/catkin_move_it/src/canopen_master/${idir}'.  Ask the maintainer 'Mathias Lüdtke <mathias.luedtke@ipa.fraunhofer.de>' to fix it.")
    endif()
